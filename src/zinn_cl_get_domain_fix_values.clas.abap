CLASS zinn_cl_get_domain_fix_values DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zinn_cl_get_domain_fix_values IMPLEMENTATION.
  ...
  METHOD if_rap_query_provider~select.
    DATA business_data TYPE TABLE OF zinn_i_domain_fix_val .
    DATA business_data_line TYPE zinn_i_domain_fix_val .
    ...
    TRY.
        ...
        IF domain_name = 'BEL_API_RETCODE'.
          domain_name = 'ZINN_E_INSTALLATIONTYPE'.
        ENDIF.
...
*           INTO TABLE @DATA(business_data2)
